...
function Vehicle(x, y) {
  ...
  let aleatoria = Math.random();
  if (aleatoria < 0.3) {
    var bandera = bandera_mx;
  }
  else if(aleatoria > 0.3 && aleatoria < 0.6) {
    var bandera = bandera_fym;
  }
  else{
    var bandera = bandera_us;
  }
  ...
  this.display = function() {
    ...
    image(bandera, this.position.x, this.position.y);
